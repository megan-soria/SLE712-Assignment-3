...
## Histogram plot of the mean values saved in png format
The hist() creats a histogram for the Mean column. The argument *xlab* creates the label for x-axis and *main* creats the title of the graph. 
